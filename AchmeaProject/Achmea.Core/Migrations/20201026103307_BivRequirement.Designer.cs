...
namespace Achmea.Core.Migrations
{
    ...
    [Migration("20201026103307_BivRequirement")]
    partial class BivRequirement
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AchmeaProject.Models.BivRequirement", b =>
                {
                    b.Property<int>("BivRequirementId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<int?>("SecurityRequirementRequirementId")
                        .HasColumnType("int");

                    b.HasKey("BivRequirementId");

                    b.HasIndex("SecurityRequirementRequirementId");
            ...
            modelBuilder.Entity("AchmeaProject.Models.BivRequirement", b =>
                {
                    b.HasOne("AchmeaProject.Models.SecurityRequirement", null)
                        .WithMany("BivRequirement")
                        .HasForeignKey("SecurityRequirementRequirementId");
                });
