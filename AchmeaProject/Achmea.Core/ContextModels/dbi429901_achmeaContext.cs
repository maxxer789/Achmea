...
{
    public partial class dbi429901_achmeaContext : Microsoft.EntityFrameworkCore.DbContext
    {
        public dbi429901_achmeaContext()
        {
        }

        public dbi429901_achmeaContext(DbContextOptions<dbi429901_achmeaContext> options)
            : base(options)
        {
        }
